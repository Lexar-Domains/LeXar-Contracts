...
contract LexarDomainSBTFactory is ILexarDomainFactory, ReentrancyGuard, Context{
  ...
  ILexarDomainHub public domainHub;
  ...
  function _createTld(
   ...
   LexarDomainSBT tld = new LexarDomainSBT(
      _name, 
      _symbol, 
      _tldOwner, 
      _domainPrice, 
